...
test('should return true for correct bitcoin addresses', () => {
  ...
  valid('12QeMLzSrB8XH8FvEzPMVoRxVAzTr5XM2y', 'Bitcoin')
  valid('12QeMLzSrB8XH8FvEzPMVoRxVAzTr5XM2y', 'btc')
  valid('12QeMLzSrB8XH8FvEzPMVoRxVAzTr5XM2y', 'btc', 'mainnet')
...
test('should return true for correct bitcoincash addresses', () => {
  ...
  valid('12QeMLzSrB8XH8FvEzPMVoRxVAzTr5XM2y', 'Bitcoin')
  valid('12QeMLzSrB8XH8FvEzPMVoRxVAzTr5XM2y', 'bch')
  valid('12QeMLzSrB8XH8FvEzPMVoRxVAzTr5XM2y', 'bch', 'mainnet')
...
test('should return true for correct litecoin addresses', () => {
...
test('should return true for correct peercoin addresses', () => {
...
test('should return true for correct dogecoin addresses', () => {
...
test('should return true for correct beavercoin addresses', () => {
...
test('should return true for correct freicoin addresses', () => {
...
test('should return true for correct protoshares addresses', () => {
...
test('should return true for correct megacoin addresses', () => {
...
test('should return true for correct primecoin addresses', () => {
...
test('should return true for correct auroracoin addresses', () => {
...
test('should return true for correct namecoin addresses', () => {
...
test('should return true for correct BioCoin addresses', () => {
...
test('should return true for correct Garlicoin addresses', () => {
...
test('should return true for correct Vertcoin addresses', () => {
...
test('should return true for correct BitcoinGold addresses', () => {
...
test('should return true for correct Decred addresses', () => {
...
test('should return true for correct Digibyte addresses', () => {
...
test('should return true for correct Ethereum addresses', () => {
...
test('should return true for correct Ripple addresses', () => {
...
test('should return true for correct dash addresses', () => {
...
test('should return true for correct neo addresses', () => {
  valid('AR4QmqYENiZAD6oXe7ftm6eDcwtHk7rVTT', 'neo')
  valid('AKDVzYGLczmykdtRaejgvWeZrvdkVEvQ1X', 'NEO')
})

test('should return true for correct neo gas addresses', () => {
  valid('AR4QmqYENiZAD6oXe7ftm6eDcwtHk7rVTT', 'neogas')
})

test('should return true for correct qtum addresses', () => {
...
test('should return true for correct votecoin addresses', () => {
...
test('should return true for correct bitcoinz addresses', () => {
...
test('should return true for correct zclassic addresses', () => {
...
test('should return true for correct hush addresses', () => {
...
test('should return true for correct zcash addresses', () => {
...
test('should return true for correct bitcoinprivate addresses', () => {
  valid('b1M4XXPFhwMb1SP33yhzn3h9qWXjujkgep4', 'bitcoinprivate')
  // valid('bx....', 'btcp')
  // valid('nx....', 'bitcoinprivate', 'testnet')
})

test('should return true for correct snowgem addresses', () => {
...
test('should return true for correct zencash addresses', () => {
...
test('should return true for correct komodo addresses', () => {
...
test('should return true for correct Bankex addresses', () => {
...
test('should return true for correct monero addresses', () => {
  valid('41ez4ahijjAJrAXpJERmGaCXvBKmdFPs5N9aqeMaZVvKKkU41Sp21GMjPHwntt97ca3zToDFXRykpYT6nCSV5gTgNafYPsf', 'monero')
...
test('should return true for correct nano addresses', () => {
...
test('should return false for incorrect bitcoin addresses', () => {
  commonTests('bitcoin')
})

test('should return false for incorrect bitcoincash addresses', () => {
  commonTests('bitcoincash')
})

test('should return false for incorrect litecoin addresses', () => {
  commonTests('litecoin')
})

test('should return false for incorrect peercoin addresses', () => {
  commonTests('peercoin')
})

test('should return false for incorrect dogecoin addresses', () => {
  commonTests('dogecoin')
})

test('should return false for incorrect beavercoin addresses', () => {
  commonTests('beavercoin')
})

test('should return false for incorrect freicoin addresses', () => {
  commonTests('freicoin')
})

test('should return false for incorrect protoshares addresses', () => {
  commonTests('protoshares')
})

test('should return false for incorrect megacoin addresses', () => {
  commonTests('megacoin')
})

test('should return false for incorrect primecoin addresses', () => {
  commonTests('primecoin')
})

test('should return false for incorrect auroracoin addresses', () => {
  commonTests('auroracoin')
})

test('should return false for incorrect namecoin addresses', () => {
  commonTests('namecoin')
})

test('should return false for incorrect biocoin addresses', () => {
  commonTests('biocoin')
})

test('should return false for incorrect garlicoin addresses', () => {
  commonTests('garlicoin')
})

test('should return false for incorrect vertcoin addresses', () => {
...
test('should return false for incorrect bitcoingold addresses', () => {
  commonTests('bitcoingold')
})

test('should return false for incorrect decred addresses', () => {
  commonTests('decred')
})

test('should return false for incorrect bankex addresses', () => {
...
test('should return false for incorrect digibyte addresses', () => {
  commonTests('digibyte')
})

test('should return false for incorrect eip55 addresses', () => {
...
test('should return false for incorrect ripple addresses', () => {
...
test('should return false for incorrect dash addresses', () => {
  commonTests('dash')
})

test('should return false for incorrect neo addresses', () => {
  commonTests('neo')
  invalid('AR4QmqYENiZAD6oXe7ftm6eDcwtHk7rVTa', 'neo')
  invalid('AKDVzYGLczmykdtRaejgvWeZrvdkVEvQ10', 'NEO')
})

test('should return false for incorrect qtum addresses', () => {
  commonTests('qtum')
...
test('should return false for incorrect votecoin addresses', () => {
...
test('should return false for incorrect bitcoinz addresses', () => {
...
test('should return false for incorrect zclassic addresses', () => {
...
test('should return false for incorrect hush addresses', () => {
...
test('should return false for incorrect zcash addresses', () => {
  commonTests('zcash')
...
test('should return false for incorrect bitcoinprivate addresses', () => {
...
test('should return false for incorrect snowgem addresses', () => {
  commonTests('snowgem')
...
test('should return false for incorrect zencash addresses', () => {
  commonTests('zencash')
...
test('should return false for incorrect komodo addresses', () => {
  commonTests('komodo')
...
test('should return false for incorrect monero addresses', () => {
  commonTests('monero')
...
test('should return false for incorrect nano addresses', () => {
  commonTests('nano')
